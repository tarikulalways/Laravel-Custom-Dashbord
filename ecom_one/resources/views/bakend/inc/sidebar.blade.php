<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme" data-bg-class="bg-menu-theme">
    <div class="app-brand demo">
        <a href="{{ route('dashbord') }}" class="app-brand-link">
    ...
    <ul class="menu-inner py-1 ps ps--active-y">
            ...
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="{{ route('subCategory.create') }}" class="menu-link">
                        <div data-i18n="Account">Add New Sub Category</div>
                    </a>
                </li>

                <li class="menu-item">
                    <a href="{{ route('subCategory.index') }}" class="menu-link">
                        <div data-i18n="Account">All Sub Category</div>
                    </a>
                </li>
            </ul>
        </li>
            ...
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="{{ route('brand.create') }}" class="menu-link">
                        <div data-i18n="Account">Add New Brand</div>
                    </a>
                </li>
            ...
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="ui-accordion.html" class="menu-link">
                        <div data-i18n="Accordion">Add New Products</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="ui-alerts.html" class="menu-link">
                        <div data-i18n="Alerts">All Products</div>
                    </a>
                </li>
            </ul>
        </li>
        ...
        {{-- users start --}}
        <li class="menu-header small text-uppercase">
            <span class="menu-header-text">User Lists</span>
        </li>
        <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-dock-top"></i>
